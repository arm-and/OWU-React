        ...
        <div className={'App'}
            ...
            <div>
                ...
                <div style={{backgroundColor: "red"}}>
                    <button onClick={() => dispatch(incAction(100))}>INC_CUSTOM</button>
                    <hr/>
                    <button onClick={() => dispatch(incAction(1))}>INC</button>
                    <button onClick={() => dispatch(decAction(1))}>DEC</button>
                    <button onClick={() => dispatch(resetAction())}>RESET</button>
                    <hr/>
                </div>
                <div style={{backgroundColor: "green"}}>
                    <button onClick={() => dispatch(incActionTwo(100000))}>INC_CUSTOM</button>
                    <hr/>
